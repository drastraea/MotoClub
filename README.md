...
Frontend, backend, and supporting assets for the MotoClub app.

## Contents

- **[`frontend/`](frontend/)** — the Next.js site (App Router, TypeScript,
  Tailwind, shadcn/ui). See [`frontend/README.md`](frontend/README.md) for
...
Requires Podman (or Docker) for the backend — no local Go toolchain needed.
